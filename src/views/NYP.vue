    ...
    <v-row>
      <v-col>
        <div class="float-right mx-10">
          <span class="mx-10">Trend in the Last 120 Days</span>
    ...
    return {
      url:
        process.env.NODE_ENV === 'production'
          ? '/k/app/kibana#/dashboard/fa8adaa0-71d8-11ea-b285-8bb2fd0522c9?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-120d%2Cto%3Anow))'
          : 'https://blank.org/',
      snackbar: false,
      timeout: 15000
    };
